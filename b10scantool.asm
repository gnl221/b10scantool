...
db 8,0,' ⁄',12,'ABOUT',8,'ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø ⁄',12,'PARALLEL',8
db  'ƒ',12,'PORT',8,'ƒ',12,'INTERFACE',8,'ƒ',12,'(RECOMMENDED)',8,'ƒƒø '
...
db  '2 ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ 13',16,8,8,'≥ '
db ' ≥',16,4,15,'Subaru Legacy Models',16,10,8,'≥ ≥     ',15
db  '3 ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ 1',16,9,8,'≥ '
db ' ≥',15,' Vikash Goel ',10,'vikashgoel',40h,'gmail',2eh,'com ',8,'≥ ≥     '
db  15,'9 ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ 25',16,8,8,'≥ '
db ' ≥',10,'http://www.surrealmirage.com/vrg3/',8,'≥ √',12,'SERIAL',8,'ƒ',12
db  'PORT',8,'ƒ',12,'INTERFACE',8,'ƒ',12,'(EXPERIMENTAL!)',8,'ƒƒ¥ '
db ' ¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ ≥   ',9,'Select',16,16
db  'DB9 serial    ',8,'≥ '
db ' ⁄',12,'KEYS',8,'ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø ≥    ',9,'pin     ',15
db  'c',16,15,9,'pin ',8,'⁄ƒƒƒƒƒƒŸ '
db ' ≥',9,'Space',16,3,15,'Next parameter',16,12,8,'≥ ≥',16,9,15
db  'b€/ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ 7  ',8,'≥  ',11,'⁄ƒø   '
db 8,' ≥',9,'BkSp',16,4,15,'Previous parameter',16,8,8,'≥ ≥',16,5,15
db  '2 ƒƒƒ€ 2N3904',16,14,8,'≥  ',11,'≥P≥   '
db 8,' ≥',9,'Esc',16,5,15,'Quit',16,22,8,'≥ ≥',16,10,15
db  '€\ƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ 1  ',8,'≥  ',11,'≥R≥   '
db 8,' ≥',9,'Enter',16,3,15,'Re-initialize parameter   ',8,'≥ ≥',16,11,15
db  'e     ¿ƒƒ/\/\/ƒƒƒ 3  ',8,'≥  ',11,'≥E≥   '
db 8,' ¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ ≥',16,21,15,'10K',16,8,8,'≥  ',11
db  '≥S≥   '
db 8,' ⁄',12,'DIAGNOSTIC',8,'ƒ',12,'PORT',8,'ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒø ≥     ',15
db  '9 ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒ 5  ',8,'≥  ',11,'≥S≥   '
db 8,' ≥',16,21,14,'⁄ƒ¬ƒø ⁄ƒ¬ƒø  ',8,'≥ ≥',16,12,15,'_≥_',16,17,8,'≥  ',11
db  '≥ ≥   '
db 8,' ≥ ',15,'Yellow 9-pin Subaru ',14,'≥1≥2≥‹≥3≥4≥  ',8,'≥ ≥',16,10,15
db  '≥_\_/_ 1N4733A',16,8,8,'≥  ',11,'≥A≥   '
db 8,' ≥ ',15,'Select Monitor port ',14,'√ƒ≈ƒ≈–≈ƒ≈ƒ¥  ',8,'≥ ≥',16,13,15
db  '≥  ≥',16,15,8,'≥  ',11,'≥ ≥   '
db 8,' ≥',16,21,14,'≥5≥6≥7≥8≥9≥  ',8,'≥ ≥',16,5,15
db  '3 ƒƒƒƒƒƒ¡ƒƒƒƒƒ/\/\/ƒƒƒƒ 4  ',8,'≥  ',11,'≥K≥   '
db 8,' ≥',16,21,14,'¿ƒ¡ƒ¡ƒ¡ƒ¡ƒŸ  ',8,'≥ ≥',16,20,15,'10K',16,9,8,'≥  ',11
db  '≥E≥   '
db 8,' ¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ '
db  '¿ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ  ',11,'≥Y≥   '
db 16,74,11,'¿ƒŸ   '
db 7
